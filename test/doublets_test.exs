defmodule DoubletsTest do
  ...
  test "Complete sequence variants, no words in dictionary" do
    assert Doublets.Solver.complete_seq_variants(["head", "heal", "teal", "tell", "tall", "call", "fall"]) == 
      []
  end
  ...
  test "Get words with same length" do
    ...
    [
      "muta", "fall", "call", "task", "quat", "head", "heal", "teal", "tell", "tall",
      "tail", "door", "boor", "book", "look", "lock", "bank", "bonk", "loon", "loan"
    ]
    assert Doublets.Solver.same_length_words("fizzbuzz") ==
    [
      "tunnland", "trewsman", "leisured", "expedite", "wartweed", "atreptic",
      "canonist", "bushveld", "kipperer", "kitthoge", "wardmaid", "jubilist",
      "surmount", "weakfish", "playwork"
    ]
